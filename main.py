...
Original file is located at
    https://colab.research.google.com/drive/1vlK3Kz2l18yiZEy5fVw_qm5j5JY9nvsa
...
print("Temperature in Clesius is:", celsius)
...
else: print("Triangle cannot be drawn")
...
if operation == "+":
  ...
  if num2 == 0: result = "You cannot devide by 0"
  else:
    result = num1 / num2
else:
    result = "Invalid operation"
